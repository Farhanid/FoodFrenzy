...
//       try {
//         // const { data } = await axios.get('https://foodfrenzy-backend.onrender.com/api/items');
...
//     try {
//       // await axios.delete(`https://foodfrenzy-backend.onrender.com/api/items/${itemId}`)
...
import { FiHeart, FiStar, FiTrash2 } from 'react-icons/fi'
import axios from "axios";
import { getImageUrl } from '../utils/imageHelper'; // ✅ IMPORT ADDED
