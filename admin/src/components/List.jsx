...
//                         className={item.img}
//                         onError={(e) => {
//                           console.warn(`Admin: Image failed for ${item.name}:`, item.imageUrl);
//                           e.target.src = '/admin-placeholder.jpg';
//                           e.target.alt = `Failed to load: ${item.name}`;
//                         }}
//                       />
//                     </td>
...
import React, { useEffect, useState } from 'react'
import { styles } from '../assets/dummyadmin'
import { FiHeart, FiStar, FiTrash2, FiEdit2 } from 'react-icons/fi'  // ✅ ADDED EDIT ICON
import axios from "axios";
import { getImageUrl } from '../utils/imageHelper';
            ...
            <table className={styles.table}>
              <thead className={styles.thead}>
                <tr>
                  ...
                  <th className={styles.th}>Rating</th>
                  <th className={styles.th}>Hearts</th>
                  <th className={styles.thCenter}>Actions</th>  {/* ✅ CHANGED from "Delete" to "Actions" */}
                </tr>
              </thead>
              <tbody>
                {items.map(item => (
                  <tr key={item._id} className={styles.tr}>
                    ...
                    <td className='p-4'>
                      <div className="flex items-center justify-center gap-3">
                        {/* ✅ ADDED - EDIT BUTTON (BEFORE DELETE) */}
                        <button
