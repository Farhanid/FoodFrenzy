...
//                                 </label>
//                                 <input type="text"
//                                     name='name' value={formData.name} onChange={handleInputChange} className={styles.inputField}
...
//                                                 <FiStar className={
//                                                     star <= (hoverRating || formData.rating) ? 'text-amber-400 fill-current' : 'text-amber-100/30'
//                                                 }/>
//                                             </button>
//                                          ))}
//                                     </div>
