...
//                               Your Cart is Empty
//                         </p>
//                         <Link to='/menu' className='transition-all duration-300 text-amber-100 inline-flex items-center gap-2  hover:gap-3 bg-amber-900/40 hover:bg-amber-800/50 px-6 py-2 rounded-full font-cinzel text-sm uppercase'>
//                         Browser All Items
//                         </Link>
//                      </div>
//               ) : (
...
//                     <div key={_id} className='group bg-amber-900/20 p-4 rounded-2xl border-4 border-dashed border-amber-500 backdrop-blur-sm  flex flex-col items-center gap-4 transition-all duration-300 hover:border-solid hover:shadow-xl hover:shadow-amber-900/10 transform hover:-translate-y-1 animate-fade-in '>
...
//                    <div className='flex flex-col sm:flex-row justify-between items-center hap-8'>
...
//                     <img src={selectedImage} alt="Full View" className='max-w-[90vw] max-h-[90vw] rounded-lg object-contain' />
...
const CartPage = () => {
  ...
  // FILTER OUT ITEMS WITH NULL ITEM DATA
    ...
    <div className='min-h-screen overflow-x-hidden py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#1a120b] via-[#2a1e14] to-[#3e2b1d]'>
      <div className='max-w-7xl mx-auto'>
        ...
        {validCartItems.length === 0 ? (
          <div className='text-center animate-fade-in'>
            <p className='text-amber-100/80 text-xl mb-4'>
              {cartItems.length > 0 ? 'Your cart contains invalid items' : 'Your Cart is Empty'}
            </p>
            <Link to='/menu' className='transition-all duration-300 text-amber-100 inline-flex items-center gap-2 hover:gap-3 bg-amber-900/40 hover:bg-amber-800/50 px-6 py-2 rounded-full font-cinzel text-sm uppercase'>
              Browse All Items
            </Link>
