...
//             <div className='absolute inset-0 bg-gradient-to-r from-amber-900/20  to-amber-700'>
...
//     <div className='relative'>
//       <div className='bg-gradient-to-br from-amber-900 via-amber-800 to-amber-700 text-white py-16 px-4 sm:px-8 relative overflow-hidden'>
//         <div className='absolute inset-0 bg-gradient-to-r from-amber-900/20 to-amber-700'></div>
...
//                 </div>
//                 <input type="text" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} placeholder='Discover your next favorite meal...' className='w-full py-4 pr-6 bg-transparent outline-none placeholder-amber-200/70 text-lg font-medium tracking-wide' />
//                 <button type='submit' className='mr-4 px-6 py-3 bg-gradient-to-r from-amber-400 to-amber-300 rounded-lg font-smibold text-amber-900 hover:from-amber-300 hover:to-amber-200 transition-all duration-300 shadow-lg  hover:shadow-amber-300/20'>Search</button>
...
//                 <span className='text-lg text-amber-900 font-smibold'>Watch Video</span>
...
//             <div className='relative rounded-full p-1 bg-gradient-to-br from-amber-700 via-amber-800 to-amber-400 shadow-2xl z-20 w-[250px] xs:w-[350px] h-[250px] xs:h-[300px] sm:h-[350px] mx-auto'>
...
//                 <div className='absolute inset-0 rounded-full bg-gradient-to-b from-transparent to-amber-900/40 mix-blend-miniority' />
//               </div>
//               {/*orbital images */}
//               {orbitImages.map((ImgSrc, index) =>(
//                 <div key={index} className={`absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 ${index === 0 ? 'orbit': `orbit-delay-${index * 5}`}
      ...
      <div className='bg-gradient-to-br from-amber-900 via-amber-800 to-amber-700 text-white py-16 px-4 sm:px-8 relative overflow-hidden'>
        ...
        <div className='max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 relative z-10'>
          ...
          <div className='flex-1 space-y-8 relative md:pr-8 lg:pr-19 text-center md:text-left'>
            ...
            <form onSubmit={handleSearch} className='relative max-w-2xl mx-auto md:mx-0 group'>
              <div className='relative flex items-center bg-amber-900/30 rounded-xl border-2 border-amber-500 shadow-2xl hover:bg-amber-400/50 transition-all duration-300'>
                ...
                <button
                  type='submit'
                  className='mr-4 px-6 py-3 bg-gradient-to-r from-amber-400 to-amber-300 rounded-lg font-smibold text-amber-900 hover:from-amber-300 hover:to-amber-200 transition-all duration-300 shadow-lg hover:shadow-amber-300/20'>
                  Search
                </button>
              </div>
            </form>
          ...
          <div className='flex-1 relative group mt-8 md:mt-0 min-h-[300px] sm:min-h-[400px]'>
            {/* main img */}
            <div className='relative rounded-full p-1 bg-gradient-to-br from-amber-700 via-amber-800 to-amber-400 shadow-2xl z-20 w-[250px] h-[250px] xs:w-[300px] xs:h-[300px] sm:w-[350px] sm:h-[350px] mx-auto'>
              <img
                src={bannerImage}
                alt="Banner"
            ...
            orbit orbit-delay-${index % 4}  /* or use index % orbitImages.length for dynamic */
            w-[80px] xs:w-[100px] sm:w-[150px] h-[80px] xs:h-[100px] sm:h-[150px]`}>
