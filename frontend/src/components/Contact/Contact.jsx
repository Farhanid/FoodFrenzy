...
import { FiPhone, FiGlobe, FiMail, FiMessageSquare, FiArrowRight } from 'react-icons/fi';
...
const Contact = () => {
  ...
  `;
    ...
    //WHATSAPP NO
    const whatsappNumber = '9384420820'
          ...
          <div className='space-y-6'>
            <div className='relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform transition-all duration-300 hover:scale-[1.02] animate-card-float border-l-4 border-amber-500 hover:border-amber-400 group'>
              ...
              <div className='flex items-center mb-4 relative z-10'>
                ...
                <h3 className='ml-4 text-amber-100 text-xl font-smibold'>Our Headquater</h3>
              </div>
            ...
            <div className='relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform transition-all duration-300 hover:scale-[1.02] animate-card-float border-l-4 border-green-500 hover:border-green-400 group'>
              ...
              <div className='flex items-center mb-4 relative z-10'>
                ...
                <h3 className='ml-4 text-amber-100 text-xl font-smibold'>Contact Number</h3>
              </div>
            ...
            <div className='relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform transition-all duration-300 hover:scale-[1.02] animate-card-float border-l-4 border-orange-500 hover:border-orange-400 group'>
              ...
              <div className='flex items-center mb-4 relative z-10'>
                ...
                <h3 className='ml-4 text-orange-100 text-xl font-smibold'>Email Address</h3>
              </div>
              <div className='pl-12 relative z-10'>
                <p className='text-amber-100 font-light text-lg'>
                  farhanworks123@gmail.com
                </p>
              </div>
              ...
              <div>
                ...
                <div className='relative'>
                  ...
                  <textarea rows='4' name='query' value={formData.query} onChange={handleChange} className='w-full pl-10 pr-4 py-3 bg-white/10 border-2 border-amber-500/30 rounded-xl text-amber-50 focus:ring-2 focus:ring-amber-500 focus:border-transparent placeholder-amber-200/50'
                    placeholder='Type Your Messsage here...' required>

                  </textarea>
                </div>
              </div>
              <button type='submit' className='w-full bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-semibold py-3 px-6  rounded-xl transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-500/20 flex items-center justify-center space-x-2 group '>
                <span className=''>Submit Query</span>
