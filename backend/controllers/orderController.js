...
export const createOrder = async (req, res) => {
    try{
        ...
        const {firstName, lastName, phone, email, address, city, zipCode, paymentMethod, subTotal, tax, total, items } = req.body;
        ...
        newOrder = new Order({
            ...
            tax, total,
             shipping: shippingCost,
              items: orderItems,
            sessionId: `cod_${Date.now()}_${Math.random().toString(36).substr(2, 9)}`,
...
//UPDATE ORDER WITHOUT TOKEN FOO ADMIN
